...
export const useAgendaStore = defineStore('agenda', () => {
  const items = ref<AgendaItem[]>([
    // Tue 2026-06-02 (5)
    {
      ...
      description: 'Kick off L\'Oréal ONE SINGAPORE with a vision for the future of beauty, technology, and the people who shape it.',
      speaker: 'Host',
      speakerTitle: 'MC',
    ...
    },
    {
      ...
      description: 'Explore the macro shifts reshaping beauty retail — from hyper-personalisation and bio-materials to the rise of skin longevity.',
      speaker: 'Sarah Chen',
    ...
    },
    {
      ...
      description: 'How L\'Oréal\'s R&I teams are rethinking ingredient sourcing and formula design to hit our 2030 sustainability commitments.',
      speaker: 'Marcus Lee',
    ...
    },
    {
      ...
      description: 'Live demos of the latest in-store and e-commerce innovations — AR try-on, smart mirrors, AI shelf analytics, and more.',
      speaker: 'Nina Patel',
    ...
    },
    {
      ...
      description: 'Open networking with startup founders and L\'Oréal tech leads. Bring your questions — this one\'s unscripted.',
      speaker: 'Community',
    ...
    // Wed 2026-06-03 (5)
    {
      ...
      description: 'How AI is reshaping every touchpoint of the beauty experience — from discovery to formulation to personalised retail.',
    ...
    },
    {
      ...
      description: 'Build your first agent in 45 minutes — from prompt to autonomous tool calls. A hands-on session for non-engineers.',
      speaker: 'Andy Brown',
    ...
    },
    {
      ...
      description: 'Practical frameworks for attributing revenue, efficiency, and NPS gains to AI investments — with real L\'Oréal case studies.',
      speaker: 'Andy Brown',
      speakerTitle: 'Chief AI Officer',
      speakerOrg: 'L\'Oréal Group',
      speakerImage: '/speaker-3.jpg',
    ...
    },
    {
      ...
      description: 'From 1:1 email to real-time product recommendations — how data and AI unlock true personalisation across 37 brands.',
      speaker: 'Elena Rossi',
    ...
    },
    {
      ...
      description: 'Step inside the future of formulation R&D — generative AI, high-throughput screening, and ethical ingredient sourcing in practice.',
      speaker: 'Dr. Kim',
    ...
    // Thu 2026-06-04 (5)
    {
      ...
      description: 'Craft narratives that move people — frameworks used across L\'Oréal\'s most awarded campaign teams worldwide.',
    ...
    },
    {
      ...
      description: 'Unpacking our first-party data strategy — consent, enrichment, and how we activate insights across owned and paid channels.',
      speaker: 'Priya Shah',
    ...
    },
    {
      ...
      description: 'Industry leaders debate the ethics, opportunities, and risks of data-driven beauty — from genomics to facial recognition.',
      speaker: 'Panel',
    ...
    },
    {
      ...
      title: 'Hands-on Lab',
      description: 'Get your hands into real formulas. Work alongside L\'Oréal scientists in a guided lab session — no chemistry degree required.',
      speaker: 'Facilitator',
    ...
    },
    {
      ...
      description: 'TikTok Shop, livestream selling, creator commerce — tactical playbooks from the teams driving our social revenue growth.',
      speaker: 'Mia Torres',
    ...
    // Fri 2026-06-05 (5)
    {
      ...
      description: 'A sweeping look at where beauty technology is headed — biotech, neurocosmetics, ambient commerce, and the post-screen era.',
      speaker: 'Laurence Liew',
      speakerTitle: 'Founder',
      speakerOrg: 'AI Singapore',
      speakerImage: '/speaker-1.jpg',
    ...
    },
    {
      ...
      description: 'A confidential look at our 2026–2028 partnership roadmap — technology, retail, and media alliances in the pipeline.',
      speaker: 'Andy Brown',
      speakerTitle: 'Chief AI Officer',
      speakerOrg: 'L\'Oréal Group',
      speakerImage: '/speaker-2.jpg',
    ...
    },
    {
      ...
      description: 'Eight startups. Four minutes each. One partnership deal on the table. Watch the finalists pitch to the L\'Oréal leadership panel.',
      speaker: 'Judges',
    ...
    },
    {
      ...
      description: 'An exclusive first look at what\'s shipping across L\'Oréal\'s digital product suite in H2 2026 — feedback welcome.',
    ...
    },
    {
      ...
      description: 'Celebrate four days of ideas, experiments, and connections. Awards for best pitch, most sparks earned, and team of the conference.',
      speaker: 'Host',
      speakerTitle: 'MC',
      speakerOrg: 'L\'Oréal Singapore',
      speakerImage: '/speaker-1.jpg',
    ...
    // Always-on booth tab
    {
      ...
      description: 'Drop by anytime to explore live demos of L\'Oréal\'s latest digital products — AR beauty, skin diagnostics, and the AmplifAI platform.',
      speaker: 'Booth team',
  ...
  function toggleSchedule(id: string) {
    ...
    if (item)
      item.inMySchedule = !item.inMySchedule
  }
